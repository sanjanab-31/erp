...
const StudentPortal = () => {
        ...
        const fetchRecentActivities = async () => {
            try {
                ...
                const studentAnnouncements = allAnnouncements
                    .filter(a => a.targetAudience === 'Students' || a.targetAudience === 'All')
                ...
                setRecentActivities(studentAnnouncements);
                setUnreadCount(studentAnnouncements.length);
            } catch (error) {
    ...
    const menuItems = [
        ...
        { icon: GraduationCap, label: 'Exams & Grade', path: '/student/exams' },
        { icon: BookOpen, label: 'Courses', path: '/student/courses' },
        { icon: DollarSign, label: 'Fees & Finance', path: '/student/fees' },
        { icon: Clock, label: 'Timetable', path: '/student/timetable' },
        { icon: BookMarked, label: 'Library', path: '/student/library' },
